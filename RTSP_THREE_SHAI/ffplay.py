...
RTSP_URL = "rtsp://192.168.0.122:554/rtsp/streaming?channel=1&subtype=1&onvif_metadata=true"  # RTSP stream URL
#RTSP_URL = "http://109.236.111.203/mjpg/video.mjpg"  # RTSP stream URL

JSON_UPDATE_INTERVAL = 5  # Update JSON file every 5 seconds
...
REGIONS = {
    ...
    'R3': {
        'vertices': np.array([(389,594), (1071,538), (786,423), (420,446)], dtype=np.int32),
        'weight': 0.50,
        'color': (0, 0, 255)
    }
}
    ...
    try:
        ...
        cursor.execute('''INSERT INTO traffic_data 
                    ...
                    (timestamp,
                     ...
                     region_metrics['R3']['vehicles'], region_metrics['R3']['density'],
...
def video_feed():
    processed_video_path = os.path.join(PROCESSED_FOLDER, 'processed_video.mp4')
    cmd = ['ffplay', '-i', processed_video_path]
